...
eqn_2 = np.load('gaussian_test_set_eqn_2.npy')
eqn_5 = np.load('gaussian_test_set_eqn_5.npy')
...
# xax = np.arange(10)
# plt.scatter(xax,most_0,label='Most Influenctial')
# plt.scatter(xax,least_0,label='Least Influenctial')
# plt.legend(loc='lower right',prop={'size':8})
# plt.xticks(xax)
# plt.xlabel('Top 10 Training Points')
# plt.ylabel('Influence')
# plt.title('Most vs Least Influential Points')
# plt.show()
