# -*- coding: utf-8 -*-
"""
Created on Wed Jan 29 16:58:21 2020
...
for train_index,test_index in kf.split(x_imputed):
    ...
    # pd.DataFrame(clf1.cv_results_).to_csv('results/tuning_params/no_smote/logreg_cv_results_'+str(i)+'.csv')
...
np.save('results/probs/no_smote/xgb_probs.npy',logreg_probs)
# np.save('results/probs/smote/xgb_prob.npy',xgb_probs)
# np.save('results/coefs_no_smote.npy',coefs)
np.save('results/probs/no_smote/xgb_test_labels.npy',test_labels)