# -*- coding: utf-8 -*-
"""
Created on Fri Dec 20 17:05:16 2019
...
model = torch.load('3-layer_model.pt')
...
v = model.lin1.weight.grad.clone()
...
np.save('results/eqn_2_3layer_lin1.npy',eqn_2)
np.save('results/eqn_5_3layer_lin1.npy',eqn_5)